"""IStepFormDef for SECTION_STEPS."""
...
class SectionFormDef(IStepFormDef):
    """Form definition for the section step."""
    ...
    def _build_subform_title(frame: ttk.Frame, widgets: dict[str, Any]) -> None:
        ...
        ttk.Label(row0, text="Titre :").pack(side="left", padx=(0, 5))
