...
class CloseTabsFormDef(IStepFormDef):
    ...
    def load_params_step_to_widget(self, params_dict: dict[str, Any], widgets: dict[str, Any]) -> None:
        ...
        """
        widgets[C_KEY_FILTER_MODE].set(params_dict.get(C_KEY_FILTER_MODE, C_INPUT_DEFAULT_FILTER_MODE))
        widgets[C_KEY_FILTER_CUSTOM].set(params_dict.get(C_KEY_FILTER_CUSTOM, ""))
        widgets[C_KEY_MAX_TABS].set(str(params_dict.get(C_KEY_MAX_TABS, C_INPUT_DEFAULT_MAX_TABS)))
