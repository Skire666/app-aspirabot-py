...
class AppConfigurationViewModel:
    ...
    def __init__(self, master: tk.Misc) -> None:
        ...
        # State Vars — Presenter writes, View traces for button enable/disable
    ...
    def get_data(self) -> dict[str, Any]:
        """Read all form Vars and return them as a configuration dict.

        Returns:
            Dict matching the keys expected by ``AppConfigurationModel``.
        """
        return {
    ...
    def set_data(self, data: dict[str, Any]) -> None:
        """Write a configuration dict into all form Vars.
